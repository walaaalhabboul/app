...
Column(children: <Widget>[
               Image.asset('assets/images/logo.png', height: 70, width: 100, 
   ),
                Text('Acil Servis')
              ],)
        ...
        child: GridView(
          ...
          children: [
            ElevatedButton.icon(
              ...
              label: Text('Harita ', style: TextStyle(color: Colors.black)),
            onPressed: () {
            Navigator.of(context).push(MaterialPageRoute(builder: (context) {
              return Hrii();
            }));
            ...
            ElevatedButton.icon(
              ...
              label: Text('Haberler', style: TextStyle(color: Colors.black)),
              onPressed: () async {
                try {
            ...
            ElevatedButton.icon(
              ...
              label:
                  Text('Özel Hastanler', style: TextStyle(color: Colors.black)),
              onPressed: () async {
                try {
